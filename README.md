...
Further authoring rules and examples are in [`public/tutorial-deck.md`](public/tutorial-deck.md) (in-app **Tutorial**). Deck file format rules for LLM output are in [`docs/generate-deck.md`](docs/generate-deck.md).
